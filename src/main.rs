...
unsafe fn enable_shutdown_privilege() -> bool { unsafe {
    ...
    let privilege_name: [u16; 19] = [
        b'S' as u16, b'e' as u16, b'S' as u16, b'h' as u16, b'u' as u16, b't' as u16,
        b'd' as u16, b'o' as u16, b'w' as u16, b'n' as u16, b'P' as u16, b'r' as u16,
        b'i' as u16, b'v' as u16, b'i' as u16, b'l' as u16, b'e' as u16, b'g' as u16,
        b'e' as u16,
    ];
